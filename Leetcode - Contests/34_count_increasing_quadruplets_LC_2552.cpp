...
// Find number of quadruplets in the array which contains number [1, n]
// 0 <= i < j < k < l < n
...
// The ans will be:
// number of elements greater than nums[j] that comes after nums[k] 
// *
// number of elements smaller than nums[k] that comes before nums[j]
